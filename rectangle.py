...
def main():
    ...
    view = BoundingBox(img, 'Slot', 500, 60, (0,255,0))
...
class BoundingBox:
    ...
    def __init__(self, image, name, width, height, color):
        self.image = image 
        self.name = name
        self.color = color
        self.default_width  = width
        self.default_height  = height
        self.end = np.array([100+self.default_width, 100+self.default_height])
        #Store in a temporary variable to avoid printing to terminal
